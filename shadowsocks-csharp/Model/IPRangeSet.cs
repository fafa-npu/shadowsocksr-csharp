...
namespace Shadowsocks.Model
{
    ...
    {
        private const string APNIC_FILENAME = "resources/apnic.db";
        private const string APNIC_EXT_FILENAME = "resources/apnic-ext.db";
        private const string CHN_FILENAME = "resources/chn.db";
        private uint[] _set;
